...
{
    // SWT Implementation from 
    // http://msdn.microsoft.com/en-us/library/system.identitymodel.tokens.securitytoken(v=vs.110).aspx
    // and
    // http://code.msdn.microsoft.com/vstudio/Custom-Token-ddce2f55/view/SourceCode

    /// <summary> 
    /// This class represents the token format for the SimpleWebToken. 
    /// </summary> 
    public class SwtSecurityToken : SecurityToken
    {
        ...
        internal SwtSecurityToken( NameValueCollection properties, string serializedToken )
            : this(properties)
        {
        ...
        /// </summary> 
        /// <param name="properties">The collection represents all the key value pairs in the token.</param>
        public SwtSecurityToken(NameValueCollection properties)
        {
            if ( properties == null )
            {
